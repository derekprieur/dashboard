...
const Notification = () => {
    const { currentColor, handleClickForClose } = useStateContext();
    ...
    return (
        <div className="nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
            <div className="flex justify-between items-center">
                ...
                <button type='button' onClick={() => handleClickForClose('notification')} style={{ color: 'rgb(153, 171, 180)', borderRadius: '50%' }}
